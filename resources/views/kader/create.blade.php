...
<div class="max-w-2xl mx-auto bg-slate-900 border border-slate-800 rounded-3xl p-6 sm:p-8 shadow-xl space-y-6">
    ...
    <div class="flex items-center justify-between border-b border-slate-800/80 pb-4">
        <div>
            <h2 class="text-lg font-extrabold text-white">Form Akun Kader Baru</h2>
            <p class="text-xs text-slate-400 mt-1">Lengkapi data akun untuk petugas kader yang ditugaskan di Posyandu.</p>
        </div>
    ...
    <form action="{{ route('kader.store') }}" method="POST" class="space-y-5">
        ...
        <!-- Password -->
        <div>
            <label for="password" class="block text-xs font-bold uppercase tracking-wider text-slate-300 mb-1.5">Password Akun <span class="text-rose-400">*</span></label>
